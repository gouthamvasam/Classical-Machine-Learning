...
#train_path = 'PE2_SVM_Divided_TT_70-30_8DA_1image/train'  # Names are MVM- and MVM+
train_path = 'PE2_SVM_Divided_TT_70-30_8DA_1image/train'  # Folder Names are MVM- and MVM+
...
k = 100  #try kmeans with 100, 200 and (maybe 300) clusters
...
joblib.dump((clf, training_names, stdSlr, k, voc), "PE2_DA_bovw_sift500_km100_XGB200.pkl", compress=3)